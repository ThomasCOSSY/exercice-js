...
let changeSecondElement = function (array) {
  ...
  return array;
  //splice pour intégrer un element, premier chiffre la position (0=1element, 1=2element ect...), deuxeme chiffre 0 on rajoute un index, 1 on modifie un element
}
...
let returnArray = function (string) {
  ...
  // creation d un tableau array + split/séparation des mots contenue dnas string en se basant sur les virgules
  return array;
}
